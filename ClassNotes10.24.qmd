...
What if the thing we need to automate isn't just a function like `typeof`? For instance, suppose I want to keep the 4 lowest values of each column of the`rock` set?
